...
-- Lua port of UserConfigs/UserAnimations.conf (personal "End-4" animation
-- preset -- https://github.com/end-4/dots-hyprland -- not vendor stock).
-- This file was previously an empty example template, so under the Lua
-- entrypoint these curves/animations were silently missing.
