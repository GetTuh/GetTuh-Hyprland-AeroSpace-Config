...
-- Real Lua port of configs/WindowRules.conf, loaded via user_overrides.lua's
-- system_files legacy fallback. Content copied from vendor's lua/window_rules.lua
-- template, which is never dofile'd by hyprland.lua on its own -- without this
-- override none of the default window tags/float/opacity/center rules apply
-- under the Lua entrypoint.
