-- Lua port of the exec-once = kwalletd6 line in UserConfigs/UserSettings.conf.
...
-- Start KWallet so apps using the Secret Service API (e.g. Brave sync) can
-- find a keyring outside of a KDE session
exec_once("kwalletd6")
