...
-- Real Lua port of configs/Startup_Apps.conf, loaded via user_overrides.lua's
-- system_files legacy fallback. Content copied from vendor's lua/startup.lua
-- template, which is never dofile'd by hyprland.lua on its own -- without this
-- override, waybar/hypridle/polkit/clipboard etc. never launch under the Lua
-- entrypoint.
